 ...
 $numero_filas = $consulta->num_rows;
             ...
             if (isset($_GET['pagina'])) {
              ...
              $pagina_inicio=($pagina-1)*$tamano;
               $consulta =$conexion->consulta("SELECT id_comida,nombre,estado,fecha,total FROM  tbl_comidas order by nombre desc  LIMIT $pagina_inicio,$tamano ");

              }else{
     $consulta =$conexion->consulta("SELECT id_comida,nombre,estado,fecha,total FROM  tbl_comidas order by nombre desc LIMIT 0,$tamano ");
}
