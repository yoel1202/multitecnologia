 ...
 $tamano=10;
    $consulta =$conexion->consulta("SELECT idl_cliente,nombre,apellido,cedula FROM  tbl_clientes order by nombre    ");
            ...
            if (isset($_GET['pagina'])) {
              ...
              $consulta =$conexion->consulta("SELECT idl_cliente,nombre,apellido,cedula,correo,telefono,tarjeta,fecha_vencimiento,cvc FROM  tbl_clientes order by nombre  LIMIT $pagina_inicio,$tamano   ");
    
            }else{

              $consulta =$conexion->consulta("SELECT idl_cliente,nombre,apellido,cedula,correo,telefono,tarjeta,fecha_vencimiento,cvc FROM  tbl_clientes order by nombre  LIMIT 0,$tamano   ");
            }
