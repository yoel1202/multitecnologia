...
<!-- /navbar -->
    ...
    <li><a href="lista_reservas.php">Lista de Reservas</a></li>
                   ...
                   <li  class="dropdown active"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="fas fa-bed"></i><span>Habitaciones</span> <b class="caret"></b></a>
                 <ul class="dropdown-menu">
 ...
 $tamano=10;
    $consulta =$conexion->consulta("SELECT id_habitacion,nombre,numero_habitacion,cantidad,estado FROM  tbl_habitaciones order by nombre    ");
            ...
            if (isset($_GET['pagina'])) {
              ...
              $consulta =$conexion->consulta("SELECT id_habitacion,nombre,numero_habitacion,cantidad,estado FROM  tbl_habitaciones order by nombre  LIMIT $pagina_inicio,$tamano   ");
    
            }else{

              $consulta =$conexion->consulta("SELECT id_habitacion,nombre,numero_habitacion,cantidad,estado FROM  tbl_habitaciones order by nombre  LIMIT 0,$tamano   ");
            }
